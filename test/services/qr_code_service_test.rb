...
class QrCodeServiceTest < ActiveSupport::TestCase
  test "generate_svg returns SVG string" do
    svg = QrCodeService.generate_svg("https://todaybike.cyanluna.com/passport/test-token")
    assert_includes svg, "<svg"
    assert_includes svg, "</svg>"
  end

  test "generate_png returns PNG data" do
    png = QrCodeService.generate_png("https://todaybike.cyanluna.com/passport/test-token")
  ...
  test "passport_url generates correct URL" do
    ...
    assert_equal "https://todaybike.cyanluna.com/passport/abc123", url
  end
end
